...
FnsToEvaluate_3.PayrollTaxRevenue.household=@(labor,buyhouse,saprime,hprime,sa,h,solarpv,z,e,ypp,agej,Jr,tau_l,w,kappa_j,Lhscale) ...
    (agej<Jr)*tau_l*labor*w*kappa_j*exp(z+e); % Total spending on payroll taxes
FnsToEvaluate_3.CapitalGainsTaxRevenue.household=@(labor,buyhouse,saprime,hprime,sa,h,solarpv,z,e,ypp,agej,P0,AccidentBeqS_pp,r_pp,tau_cg,S_agej_first,S_agej_peak_first,S_agej_peak_last,S_agej_last) ...
    Electrify_HouseholdCapitalGainsFn(labor,buyhouse,saprime,hprime,sa,h,solarpv,z,e,ypp,agej,0,P0,AccidentBeqS_pp,r_pp,tau_cg,S_agej_first,S_agej_peak_first,S_agej_peak_last,S_agej_last);
FnsToEvaluate_3.BeqleftS_pp.household=@(labor,buyhouse,saprime,hprime,sa,h,solarpv,z,e,sj,n_pp,ypp,agej,P0,AccidentBeqS_pp,r_pp,tau_cg,S_agej_first,S_agej_peak_first,S_agej_peak_last,S_agej_last) ... % Accidental bequests left by people who die, (possibly after estate taxes) and dilution to dependents
    ((logical(saprime>=1)*fix(saprime))-Electrify_HouseholdCapitalGainsFn(labor,buyhouse,saprime,hprime,sa,h,solarpv,z,e,ypp,agej,1,P0,AccidentBeqS_pp,r_pp,tau_cg,S_agej_first,S_agej_peak_first,S_agej_peak_last,S_agej_last))*(1-sj)/(1+n_pp);
% AccidentalBeqAHLeft is zero (if in debt) or accidental asset+house bequests left by people who die
FnsToEvaluate_3.BeqleftAH_pp.household=@(labor,buyhouse,saprime,hprime,sa,h,solarpv,z,e,scenario,sj,cpi) ...
...
FnsToEvaluate_4.PayrollTaxRevenue.household=@(labor,buyhouse,saprime,cprime,hprime,sa,car,h,solarpv,z,e,ypp,agej,Jr,tau_l,w,kappa_j,Lhscale) ...
    (agej<Jr)*tau_l*labor*w*kappa_j*exp(z+e); % Total spending on payroll taxes
FnsToEvaluate_4.CapitalGainsTaxRevenue.household=@(labor,buyhouse,saprime,cprime,hprime,sa,car,h,solarpv,z,e,ypp,agej,P0,AccidentBeqS_pp,r_pp,tau_cg,S_agej_first,S_agej_peak_first,S_agej_peak_last,S_agej_last) ...
    Electrify_4HouseholdCapitalGainsFn(labor,buyhouse,saprime,cprime,hprime,sa,car,h,solarpv,z,e,ypp,agej,0,P0,AccidentBeqS_pp,r_pp,tau_cg,S_agej_first,S_agej_peak_first,S_agej_peak_last,S_agej_last);
FnsToEvaluate_4.BeqleftS_pp.household=@(labor,buyhouse,saprime,cprime,hprime,sa,car,h,solarpv,z,e,sj,n_pp,ypp,agej,P0,AccidentBeqS_pp,r_pp,tau_cg,S_agej_first,S_agej_peak_first,S_agej_peak_last,S_agej_last) ... % Accidental bequests left by people who die, (possibly after estate taxes) and dilution to dependents
    ((logical(saprime>=1)*fix(saprime))-Electrify_4HouseholdCapitalGainsFn(labor,buyhouse,saprime,cprime,hprime,sa,car,h,solarpv,z,e,ypp,agej,1,P0,AccidentBeqS_pp,r_pp,tau_cg,S_agej_first,S_agej_peak_first,S_agej_peak_last,S_agej_last))*(1-sj)/(1+n_pp);

% AccidentalBeqAHLeft is zero (if in debt) or accidental asset+house bequests left by people who die
FnsToEvaluate_4.BeqleftAH_pp.household=@(labor,buyhouse,saprime,cprime,hprime,sa,car,h,solarpv,z,e,scenario,sj,cpi) ...
    max(0,(logical(saprime<1)*saprime+logical(saprime>1)*rem(saprime,1)+(1+cpi)*hprime*(1-sj)));
% BadDebt is the debt somebody accidentally leaves behind, or zero if net worth is positive
...
FnsToEvaluate2_3.BadDebt_pp.household=@(labor,buyhouse,saprime,hprime,sa,h,solarpv,z,e,scenario,sj,cpi) ...
...
FnsToEvaluate2_4.BadDebt_pp.household=@(labor,buyhouse,saprime,cprime,hprime,sa,car,h,solarpv,z,e,scenario,sj,cpi) ...
    min(0,(logical(saprime<1)*saprime+logical(saprime>1)*rem(saprime,1)+(1+cpi)*hprime)*(1-sj));
