function [ReturnFn,FnsToEvaluate,FnsToEvaluate2,FnsToEvaluate3,vfoptions,simoptions] = Electrify_Scenario_Fn_Setup(Params,vfoptions,simoptions)
    ...
    ReturnFn_4.energy=@( ...
            installpv,kprime,k,pv,z, ...
            ypp,delta,EnergyCosts_h,EnergyCosts_f ...
    ...
    FnsToEvaluate_4.CarbonCosts_f.firm=@(installpv,kprime,k,pv,z,w,ypp,alpha_k,alpha_l,Ek,ek,pv_max_firm,carbon_tax) ...
        Electrify_4FirmCarbonCosts(installpv,kprime,k,pv,z,w,ypp,alpha_k,alpha_l,Ek,ek,pv_max_firm,carbon_tax);
    ...
    FnsToEvaluate2_4.CarbonCosts_f.firm=@(installpv,kprime,k,pv,z,w,ypp,alpha_k,alpha_l,Ek,ek,pv_max_firm,carbon_tax) ...
        Electrify_4FirmCarbonCosts(installpv,kprime,k,pv,z,w,ypp,alpha_k,alpha_l,Ek,ek,pv_max_firm,carbon_tax);
