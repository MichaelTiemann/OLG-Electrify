...
Params.firmbeta=1/(1+Params.r_pp/(1-Params.tau_cg)); % 1/(1+r_pp) but returns net of capital gains tax
Params.D=0.2; % Annual dividends rate expected/received by households
Params.P0=1;
...
if Params.scenario<3
    ...
    this_F=Electrify_HouseholdReturnFn( ...
        ...
        Params.pension,Params.AccidentBeqS_pp,Params.AccidentBeqAH_pp,Params.w,Params.P0,Params.D, ...
...
Params.P0-((((1-Params.tau_cg)*Params.P0 + (1-Params.tau_d)*((1+Params.D)^Params.ypp-1))/(1+Params.r_pp-Params.tau_cg))-AggVars.S.Mean)
...
P=((1-Params.tau_cg)*Params.P0 + (1-Params.tau_d)*((1+Params.D)^Params.ypp-1))/(1+Params.r_pp-Params.tau_cg);
