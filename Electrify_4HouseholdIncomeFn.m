function income=Electrify_4HouseholdIncomeFn( ...
    ...
    r,energy_cpi,energy_pct_cost,energy_pct_brown,carbon_tax)
...
income=income+(1+energy_cpi)*energy_pct_cost*(solarpv/2);
if a>0
