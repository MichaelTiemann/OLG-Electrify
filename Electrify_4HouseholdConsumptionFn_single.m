...
if cprime==0
    ...
    if car~=0
        ...
        carcost_pp=carcost+0.03*w*ypp;
    end
else
    if car==0
        if cprime==1
            carcost=0.6*w; % Buying from scratch; cheap petrol car
        else
    ...
    elseif car<cprime
        ...
        carcost=0.2*w; % Minimal extra cost to move backwards
    end
...
c_pp=c_pp-htc-rentalcosts_pp-hcost*0.04*ypp-pvinstallcost;
