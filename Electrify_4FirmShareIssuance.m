function s=Electrify_4FirmShareIssuance(electrification,kprime,pvprime,k,pv,z,w,ypp,delta,alpha_k,alpha_l,capadjconstant,tau_corp,phi)
...
invest=kprime-(1-delta_pp)*k+electrification;
