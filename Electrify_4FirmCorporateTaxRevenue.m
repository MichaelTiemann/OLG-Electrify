function revenue=Electrify_4FirmCorporateTaxRevenue(pvnew,kprime,k,pv,z,w,pvinstalled_firm,pvmax_firm,delta,pv_delta,alpha_k,alpha_l,capadjconstant,tau_corp,phi,Ek,ek,energy_pct_brown,carbon_tax)
